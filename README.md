...
🗺 Architecture
RuralCare AI uses an Offline-First sync strategy, ensuring health workers can operate in areas with zero connectivity and sync data once a network is available.
🤝 Contributing
